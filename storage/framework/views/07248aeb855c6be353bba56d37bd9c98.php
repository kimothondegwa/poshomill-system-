...
<div class="row mb-4">
    <div class="col-md-4">
        <div class="metric-card revenue">
            ...
            <div class="metric-value">KSh <?php echo e(number_format($sales->sum('final_amount'), 2)); ?></div>
    ...
    <div class="col-md-4">
        <div class="metric-card quantity">
            ...
            <div class="metric-value"><?php echo e(number_format($sales->sum('quantity'), 2)); ?></div>
    ...
    <div class="col-md-4">
        <div class="metric-card transactions">
            ...
            <div class="metric-value"><?php echo e($sales->count()); ?></div>
...
<div class="sales-table-card">
    ...
    <div class="table-responsive">
        <table class="table">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $sales->take(20); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td><span class="sale-number">#<?php echo e($sale->sale_number); ?></span></td>
                        <td><strong><?php echo e($sale->customer_name); ?></strong></td>
                        <td><span class="badge" style="background: #dbeafe; color: #0369a1;"><?php echo e($sale->quantity); ?> kg</span></td>
                        <td><span class="sale-amount">KSh <?php echo e(number_format($sale->final_amount, 2)); ?></span></td>
                        <td>
                            <?php
                            ...
                            ?>
                            <span class="sale-badge <?php echo e($badgeClass); ?>">
                                <i class="fas
                                    <?php if(strtolower($sale->payment_method) == 'cash'): ?> fa-money-bill-wave
                                    <?php elseif(strtolower($sale->payment_method) == 'card'): ?> fa-credit-card
                                    <?php elseif(strtolower($sale->payment_method) == 'mpesa'): ?> fa-mobile-alt
                                    <?php else: ?> fa-exchange-alt
                                    <?php endif; ?>
                                me-1"></i><?php echo e(ucfirst($sale->payment_method)); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\posho mili project\posho_mill_laravel\resources\views/reports/sales.blade.php ENDPATH**/ ?>