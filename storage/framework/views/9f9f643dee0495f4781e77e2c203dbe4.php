...
<div class="row mb-4">
    ...
    <div class="col-md-6 col-lg-3">
        <div class="financial-stat">
            ...
            <div class="stat-value" style="font-size: 1.3rem;">KSh <?php echo e(number_format($totalCost, 2)); ?></div>
    ...
    <div class="col-md-6 col-lg-3">
        <div class="financial-stat">
            ...
            <div class="stat-value" style="font-size: 1.3rem;">KSh <?php echo e(number_format($grossProfit, 2)); ?></div>
    ...
    <div class="col-md-6 col-lg-3">
        <div class="financial-stat">
            ...
            <div class="stat-value"><?php echo e(number_format($profitMargin, 2)); ?>%</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\posho mili project\posho_mill_laravel\resources\views/reports/financial.blade.php ENDPATH**/ ?>