...
<div class="sales-hero">
    ...
    <a href="<?php echo e(route('sales.create')); ?>" class="btn">
...
<div class="table-card">
                ...
                <tbody>
                    <?php $__currentLoopData = $sales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td><span class="qty-badge"><?php echo e($sale->quantity); ?> kg</span></td>
                            <td><span class="amount-text">KSh <?php echo e(number_format($sale->final_amount, 2)); ?></span></td>
                            <td><small><?php echo e($sale->sale_date->format('M d, Y')); ?></small></td>
                            <td>
                                <a href="<?php echo e(route('sales.show', $sale)); ?>" class="btn action-btn view" title="View">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="<?php echo e(route('sales.edit', $sale)); ?>" class="btn action-btn edit" title="Edit">
    ...
    <?php else: ?>
        <div class="empty-state">
            ...
            <p class="empty-state-text">No sales recorded yet. <a href="<?php echo e(route('sales.create')); ?>">Create your first sale</a></p>
        </div>
    <?php endif; ?>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\posho mili project\posho_mill_laravel\resources\views/sales/index.blade.php ENDPATH**/ ?>