...
<div class="stock-hero">
    ...
    <a href="<?php echo e(route('stock.create')); ?>" class="btn">
...
<div class="table-card">
            ...
            <table class="table">
                ...
                <tbody>
                    <?php $__currentLoopData = $stock; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td>
                                <span class="qty-badge <?php if($item->quantity <= 50): ?> qty-low <?php else: ?> qty-high <?php endif; ?>">
                                    <?php echo e($item->quantity); ?> kg
                                </span>
                            </td>
                            <td><strong><?php echo e($item->batch_number ?? 'N/A'); ?></strong></td>
                            <td><span class="grade-badge"><?php echo e($item->quality_grade); ?></span></td>
                            <td>KSh <?php echo e(number_format($item->cost_per_kg, 2)); ?></td>
                            <td><?php echo e($item->date_received->format('M d, Y')); ?></td>
                            <td>
                                <a href="<?php echo e(route('stock.show', $item)); ?>" class="btn action-btn view" title="View">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="<?php echo e(route('stock.edit', $item)); ?>" class="btn action-btn edit" title="Edit">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <form action="<?php echo e(route('stock.destroy', $item)); ?>" method="POST" style="display:inline;">
                                    <?php echo csrf_field(); ?>
    ...
    <?php else: ?>
        <div class="empty-state">
            ...
            <p class="empty-state-text">No stock available. <a href="<?php echo e(route('stock.create')); ?>">Add your first stock</a></p>
        </div>
    <?php endif; ?>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\posho mili project\posho_mill_laravel\resources\views/stock/index.blade.php ENDPATH**/ ?>