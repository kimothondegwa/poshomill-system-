...
<?php $__env->startSection('title', 'Create Sale'); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" class="form-control <?php $__errorArgs = ['rate_per_kg'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                           id="rate_per_kg" name="rate_per_kg" required step="0.01" value="<?php echo e(old('rate_per_kg')); ?>">
                    <?php $__errorArgs = ['rate_per_kg'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>"
                           id="discount" name="discount" step="0.01" value="<?php echo e(old('discount', 0)); ?>">
...
unset($__errorArgs, $__bag); ?>"
                        ...
                        <option value="credit" <?php echo e(old('payment_method') === 'credit' ? 'selected' : ''); ?>>Credit</option>
                    </select>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control <?php $__errorArgs = ['payment_reference'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                           id="payment_reference" name="payment_reference" value="<?php echo e(old('payment_reference')); ?>">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="d-flex gap-2">
                ...
                <a href="<?php echo e(route('sales.index')); ?>" class="btn btn-secondary">Cancel</a>
            </div>
        </form>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\posho mili project\posho_mill_laravel\resources\views/sales/create.blade.php ENDPATH**/ ?>