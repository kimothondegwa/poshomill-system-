...
<div class="dashboard-header">
    <div class="row align-items-center">
        <div class="col-md-8">
            ...
            <p>Welcome back, <strong>{{ Auth::user()->full_name }}</strong>! Here's what's happening today.</p>
        </div>
    ...
    <div class="col-md-6 col-lg-3">
        <div class="stat-card card-primary-custom">
            <div class="card-body">
                ...
                <h2>KSh {{ number_format($totalSales, 2) }}</h2>
    ...
    <div class="col-md-6 col-lg-3">
        <div class="stat-card card-success-custom">
            <div class="card-body">
                ...
                <h2>{{ number_format($currentStock, 2) }} kg</h2>
...
<div class="row g-4">
                        ...
                        <tbody>
                            @foreach ($recentSales as $sale)
                                <tr>
                                    ...
                                    <td><span class="badge bg-success">{{ $sale->quantity }} kg</span></td>
                                    <td><strong>KSh {{ number_format($sale->final_amount, 2) }}</strong></td>
                                    <td><small class="text-muted">{{ $sale->sale_date->format('M d, Y') }}</small></td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
    ...
    <div class="col-lg-4">
        <div class="card quick-actions-card">
            ...
            <div class="card-body">
                <a href="{{ route('sales.create') }}" class="btn action-btn btn-primary-custom w-100 mb-3">
                    <i class="fas fa-plus-circle"></i>
                    <span>New Sale</span>
                </a>
                <a href="{{ route('stock.create') }}" class="btn action-btn btn-success-custom w-100 mb-3">
                    <i class="fas fa-box"></i>
                    <span>Add Stock</span>
                </a>
                <a href="{{ route('customers.create') }}" class="btn action-btn btn-info-custom w-100 mb-3">
                    <i class="fas fa-user-plus"></i>
                    <span>New Customer</span>
                </a>
                <a href="{{ route('reports.index') }}" class="btn action-btn btn-secondary-custom w-100">
