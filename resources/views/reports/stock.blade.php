...
<div class="row mb-4">
    ...
    <div class="col-md-4">
        <div class="stat-card info">
            ...
            <div class="stat-value">KSh {{ number_format($totalStockValue, 2) }}</div>
            ...
            <tbody>
                @forelse ($stock as $item)
                    <tr>
                        ...
                        <td><span class="badge" style="background: #dbeafe; color: #0369a1;">{{ number_format($item->quantity, 2) }} kg</span></td>
                        <td>KSh {{ number_format($item->cost_per_kg, 2) }}</td>
                        <td><strong>KSh {{ number_format($item->total_cost, 2) }}</strong></td>
                        <td>
