...
<div class="table-card">
                ...
                <tbody>
                    @foreach ($customers as $customer)
                        <tr>
                            ...
                            <td><span class="contact-info">{{ $customer->email ?? 'N/A' }}</span></td>
                            <td><span class="contact-info">{{ $customer->phone }}</span></td>
                            <td>
                                @if ($customer->location)
                                    <span class="location-badge">{{ $customer->location }}</span>
                                @else
    ...
    @else
        <div class="empty-state">
            ...
            <p class="empty-state-text">No customers yet. <a href="{{ route('customers.create') }}">Add your first customer</a></p>
        </div>
    @endif
</div>
@endsection
